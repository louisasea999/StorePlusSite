<template>
  <div id="SaleDataNumPercent" class="SaleDataNumPercent">
    <!-- 内容 -->
    <m-echarts
...
<script>
  ...
  export default {
    ...
    created(){
      // 获取屏幕高度
      this.mechartStyle.height = document.getElementById("SaleDataNumPercent").height + 'px';
